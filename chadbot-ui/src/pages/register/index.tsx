...
const RegisterPage = () => {
    const { formData, handleChange, handleSubmit, resetForm, loading, error } = useFormUpload<UserProfile>(
        initialUser,
        (data) => {
                ...
                <form onSubmit={onSubmit} className="space-y-4">
                    ...
                    <div>
                        ...
                        <textarea
                            ...
                            value={formData.goal}
                            onChange={handleChange}
                            className="placeholder-blue-300 sm:text-sm w-full h-20 px-4 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 text-blue-600 align-text-top"
